          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-white/15 pl-[90px] pr-6 py-5">
              <div className="flex flex-col flex-1">
                {/* Show headings only when not in video player mode */}
                {!selectedVideo && (
                  <>
                ...
                {/* Back Button - only show when in video viewer */}
                {selectedVideo && (
                  <div>
                    <button
                      onClick={handleBackClick}
                      className="flex items-center gap-2 bg-[var(--bg-trans-15)] px-4 py-2.5 rounded-[8px] hover:bg-[var(--accent-main)] transition-colors duration-200 group cursor-pointer"
                    >
                      <ChevronLeft className="w-4 h-4 text-[var(--text-secondary)] group-hover:text-[#121212]" />
            ...
            >
              {selectedVideo ? (
                /* Video Player View - Larger iframe, no similar videos */
                <div className="flex justify-center items-center min-h-full px-6 py-6">
                  <iframe
                    width="1250"
                    height="703"
