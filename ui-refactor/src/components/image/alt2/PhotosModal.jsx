...
export default function PhotosModal({ isOpen, onClose, movie }) {
  ...
  }, [onClose, showFullPhoto]);

  // Handle photo click to open full-screen viewer
                ...
                <AnimatePresence mode="wait">
                  {currentPhotos.length > 0 ? (
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      No {selectedPhotoType} found for the selected language.
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 pb-8 px-6">
                  ...
                  <button
                    ...
                    disabled={validCurrentPage === totalPages || isAnimating}
                    className={`w-[36px] h-[36px] flex items-center justify-center rounded-full transition-colors duration-200 ${
